...
module.exports =
  initialize: (state) ->
    ...
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-c°c", =>
      @insertIt("alt-ctrl-c°c")
    ...
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-c°n", =>
      @insertIt("alt-ctrl-c°n")
    ...
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-c°t°c", =>
      @insertIt("alt-ctrl-c°t°c")
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-c°t°w", =>
      @insertIt("alt-ctrl-c°t°w")
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-c°w", =>
      @insertIt("alt-ctrl-c°w")
    ...
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-d°f°d", =>
      @insertIt("alt-ctrl-d°f°d")
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-d°f°f", =>
      @insertIt("alt-ctrl-d°f°f")
    ...
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-p°q°r°s", =>
      @insertIt("alt-ctrl-p°q°r°s")
    ...
    atom.commands.add "atom-workspace", "kennings:insertIt-alt-ctrl-p°r°n", =>
      @insertIt("alt-ctrl-p°r°n")
